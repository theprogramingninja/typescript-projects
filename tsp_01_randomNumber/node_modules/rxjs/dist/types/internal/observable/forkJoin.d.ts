 ...
 */
export declare function forkJoin<T extends AnyCatcher>(
	arg: T,
): Observable<unknown>;
export declare function forkJoin(
	scheduler: null | undefined,
): Observable<never>;
export declare function forkJoin(sources: readonly []): Observable<never>;
export declare function forkJoin<A extends readonly unknown[]>(
	sources: readonly [...ObservableInputTuple<A>],
): Observable<A>;
export declare function forkJoin<A extends readonly unknown[], R>(
	sources: readonly [...ObservableInputTuple<A>],
