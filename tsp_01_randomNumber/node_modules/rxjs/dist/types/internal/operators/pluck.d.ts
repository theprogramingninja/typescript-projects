...
import { OperatorFunction } from "../../../../src/internal/types";
/** @deprecated Use {@link map} and optional chaining: `pluck('foo', 'bar')` is `map(x => x?.foo?.bar)`. Will be removed in v8. */
export declare function pluck<T, K1 extends keyof T>(
	k1: K1,
): OperatorFunction<T, T[K1]>;
/** @deprecated Use {@link map} and optional chaining: `pluck('foo', 'bar')` is `map(x => x?.foo?.bar)`. Will be removed in v8. */
export declare function pluck<T, K1 extends keyof T, K2 extends keyof T[K1]>(
	k1: K1,
	k2: K2,
