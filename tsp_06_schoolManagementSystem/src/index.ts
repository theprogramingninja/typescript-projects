...
const message: string = "School Management System";
const poweredBy: string = "by RRS";

const COURSES = ['Typescript', 'NextJS', 'Metaverse', 'AI', ]
...
do {
	const choice = await inquirer.prompt([
		{
			type: "list",
			choices: ["View Balance", "Pay Fee", "Student Detail", "View Courses", "Recharge Balance", "Enroll in Course"],
			name: "functions",
